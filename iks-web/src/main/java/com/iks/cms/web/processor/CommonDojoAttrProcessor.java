 ...
 * @author Igor Kaynov
 */
public class CommonDojoAttrProcessor extends AbstractAttrProcessor {
  private String attrName;
  public CommonDojoAttrProcessor( String prefix ) {
    this( prefix, "data-dojo-" + prefix );
  }
  public CommonDojoAttrProcessor( String prefix, String attrName ) {
    super( prefix );
